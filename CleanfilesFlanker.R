...
setwd("C:/Users/dpen466/Google Drive/Phd (1)/Share_with_Chris/TCMR_Analysis_Pipeline/Erb2016_data/")
...
for (x in seq(1:folders_n)){
  ...
  colnames(trials.df) <- c("Trial", "Block","TargetLocation", "LocationTouched","Accuracy", "TrialType", 'Congruency','RT', 'Previous_response', 'Previous_congruency','trial_sequence')
