...
title('average warp angle for congruent/incongruent (RR)')
ylim([-1, 0.4]);
...
title('average warp angle for previous congruent/incongruent (RR)')
ylim([-1, 0.4]);
...
title('congruent warped angle (RR)- subject #1')
ylabel('angle (radian)')
xlabel('warped step')
...
title('incongruent warped angle (RR)- subject #1')
ylabel('angle (radian)')
xlabel('warped step')
...
title('warped angles for cc, ci, ic, & ii (RR)')
ylim([-1, 0.4]);
...
title('betas for congruency per subject (RR)')
ylabel('beta weight')
xlabel('warped step')
